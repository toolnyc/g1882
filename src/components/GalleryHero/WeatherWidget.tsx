...
export const WeatherWidget: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white/10 backdrop-blur-sm rounded-gallery px-4 py-3">
  ...
  return (
    <motion.div
      ...
      className="bg-white/10 backdrop-blur-sm rounded-gallery px-4 py-3 text-white"
    >
      <div className="text-md font-medium">{weather.temperature}°F</div>
